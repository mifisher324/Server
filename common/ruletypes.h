...
RULE_REAL(Character, ItemHealAmtCapHWis, 0.00, "Multplier on Heroic Wisdom that is then added to heal amount limit")
RULE_INT(Character, ItemSpellDmgCap, 250, "Limit on spell damage granted by items")
RULE_REAL(Character, ItemSpellDmgCapHInt, 0.00, "Multiplier on Heroic Intelligence that is then added to spell damage limit")
